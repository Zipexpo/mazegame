...
var getSizeWindow = function ({viewWidth,viewHeight}){
...
var maze = createCommonjsModule(function (module, exports) {
const {shuffle,rand} = ulti;
...
const {getSizeWindow: getSizeWindow$1,shuffle: shuffle$1,rand: rand$1} = ulti;
const {changeBrightness,displayVictoryMess,toggleVisablity,Maze,DrawMaze} = maze;
...
window.onload = function() {
    ...
    let {width,height} = getSizeWindow$1({viewWidth,viewHeight});
...
function makeMaze() {
    ...
    cellSize = mazeCanvas.width / difficulty;
    maze$1 = new Maze(difficulty, difficulty);
    draw = new DrawMaze(maze$1, ctx, cellSize, finishSprite);
    player = new Player(maze$1, mazeCanvas, cellSize, displayVictoryMess, sprite);
